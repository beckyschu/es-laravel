 ...
 * Generated for Laravel 5.2.45 on 2017-01-12.
 *
...
namespace {
    ...
    class Transaction extends \App\Facades\Transaction{
         ...
         * @static 
         */
        public static function open($type, $action){
            return \App\TransactionManager::open($type, $action);
        }
        ...
        public static function close(){
            return \App\TransactionManager::close();
        }
         ...
         */
        public static function current(){
            return \App\TransactionManager::current();
        }
        ...
        public static function currentId(){
            return \App\TransactionManager::currentId();
        }
        
    }


    class Auth extends \App\Facades\Auth{
        ...
        public static function getRawToken(){
            return \App\AuthStore::getRawToken();
        }
        ...
        public static function processToken($token){
            return \App\AuthStore::processToken($token);
        }
        ...
        public static function getUserId(){
            return \App\AuthStore::getUserId();
        }
        ...
        public static function getAccount(){
            return \App\AuthStore::getAccount();
        }
        ...
        public static function getAccountId(){
            return \App\AuthStore::getAccountId();
        }
        ...
        public static function setAccount($account){
            return \App\AuthStore::setAccount($account);
        }
        ...
        public static function isAuthenticated(){
            return \App\AuthStore::isAuthenticated();
        }
        ...
        public static function isCrawler(){
            return \App\AuthStore::isCrawler();
        }
         ...
         * @static 
         */
        public static function isEnforcer(){
            return \App\AuthStore::isEnforcer();
        }
        ...
        public static function can($permission){
            return \App\AuthStore::can($permission);
        }
         ...
         * @static 
         */
        public static function canAccessAccount($account){
            return \App\AuthStore::canAccessAccount($account);
        }
    ...
    class Tiny extends \ZackKitzmiller\Facades\Tiny{
        ...
        public static function to($id){
            return \ZackKitzmiller\Tiny::to($id);
        }
        ...
        public static function from($str){
            return \ZackKitzmiller\Tiny::from($str);
        }
        ...
        public static function generate_set(){
            return \ZackKitzmiller\Tiny::generate_set();
        }
